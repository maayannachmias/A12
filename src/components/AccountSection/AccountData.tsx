  ...
  return (
    ...
    >
      <section className="p-5 flex flex-col h-full">
        ...
        <a
          href="#"
          className="mt-4 bg-purple-100 p-2 rounded-md text-purple-600 text-center transition hover:bg-purple-200 dark:hover:bg-purple-400  dark:hover:text-purple-900 dark:bg-slate-700/[.3] dark:text-slate-200"
        >
          Collaborative Doc
        </a>
      </section>
